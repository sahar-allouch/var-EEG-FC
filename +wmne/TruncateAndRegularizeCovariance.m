...
% method neede for computing wMNE

% This code was originally developped by Sahar Yassine and Ahmad Mheich 
% based on the brainstorm toolbox codes (Tadel, F., Baillet, S., Mosher, 
% J.C., Pantazis, D., Leahy, R.M., 2011. Brainstorm: A user-friendly 
% application for MEG/EEG analysis. Computational Intelligence and 
% Neuroscience 2011. https://doi.org/10.1155/2011/879716)
